$(document).ready(function () {
    ...
    $(".main-content .year").append("<span class='current'>"+Time.yearUnit+Time.currentTime.year+"</span>");
    ...
    $(".main-content .month").append("<span class='current'>"+Time.monthUnit+Time.currentTime.month+"</span>");
    $(".main-content .day").append("<span class='current'>"+Time.dayUnit+Time.currentTime.day+"</span>");
    ...
    for (const key in Time.months) {
        if (Time.months.hasOwnProperty(key)) {
            ...
            if(element!=Time.currentTime.month){
                $(".main-content .month").append("<span>"+Time.monthUnit+element+"</span>");
            }
    ...
    for (const key in Time.days) {
        if (Time.days.hasOwnProperty(key)) {
            ...
            if(element!=Time.currentTime.day){
                $(".main-content .day").append("<span>"+Time.dayUnit+element+"</span>"); // VTSX-D start
            }
    ...
    setTimeout(function () {
        ...
        for (const key in Time.days) {
            if (Time.days.hasOwnProperty(key)) {
                const element = Time.days[key];
                if(element!=Time.currentTime.day){
                    $(".main-content .day").append("<span>"+Time.dayUnit+element+"</span>");
                }
    ...
    function run(){
        ...
        if((secText=="0 giây"||secText=="không giây"||secText=="0 s") &&(minText=="0 phút"||minText=="không phút"||minText=="0 m")){
        ...
        if((secText=="không giây"||secText=="không giây"||secText=="0 s") && (minText=="0 phút"||minText=="không phút"||minText=="0 m")&&isShichen(hourText)){
        ...
        if((secText=="0 giây"||secText=="không giây"||secText=="0 s") && (minText=="0 phút"||minText=="không phút"||minText=="0 m")&&(hourText=="0 Giờ"||hourText=="không giờ"||hourText=="0 h")){
        ...
        if((dayText=="1 day"||dayText==numToSimp(1)+"ngày"||dayText==numToTrad(1)+"ngày"||dayText=="1 ngày")&&(secText=="0 giây"||secText=="không giây"||secText=="0 s") && (minText=="0 phút"||minText=="không phút"||minText=="0 m")&&(hourText=="0 giờ"||hourText=="không giờ"||hourText=="0 h")){
        ...
        if(month==1&&(dayText=="Mông 1"||dayText=="Mông "+numToSimp(1)||dayText=="Mông "+numToTrad(1)||dayText=="Mông 1")&&(secText=="0 giây"||secText=="không giây"||secText=="0 s") && (minText=="0 phút"||minText=="không phút"||minText=="0 m")&&(hourText=="0 giờ"||hourText=="không giờ"||hourText=="0 h")){
            year++;
...
// Nhận khoảng cách đồng hồ theo kích thước phông chữ và kiểu văn bản
